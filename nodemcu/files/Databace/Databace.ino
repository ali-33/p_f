...
#define FIREBASE_HOST "medical-health-60467-default-rtdb.firebaseio.com" //--> URL address of your Firebase Realtime Database.
#define FIREBASE_AUTH "v0UoY9epowIuRRyUHWeL6VAFpgrYZ8rrKZDSksrc"  //--> Your firebase database secret code.

#define ON_Board_LED 2  //--> Defining an On Board LED, used for indicators when the process of connecting to a wifi router

//----------------------------------------SSID and Password of your WiFi router.
const char* ssid = "Tree"; //--> Your wifi name or SSID.
const char* password = "ZXCV12345"; //--> Your wifi password.
//----------------------------------------
